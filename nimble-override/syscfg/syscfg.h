/**
 * Copied from Infinitime 42a5cdb5b776c2cdeb08a8c6f26606282a809178
...
#warning Hardcoded device address
#define MYNEWT_VAL_BLE_PUBLIC_DEV_ADDR ((uint8_t[6]){0x50, 0x31, 0xad, 0xbd, 0x12, 0x5f})
#endif
